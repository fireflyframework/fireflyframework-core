...
package com.firefly.common.core.messaging.integration;
...
/**
 * Customer Registration Saga demonstrating CQRS + lib-transactional-engine integration with lib-common-core.
 ...
 * - lib-common-cqrs for CQRS commands and queries
 * - lib-common-core messaging for step events publishing
 */
@Component
...
public class CustomerRegistrationSagaTest {
    ...
    // Data classes (same as in lib-common-domain for compatibility)
    ...
    public static class ValidateCustomerQuery implements com.firefly.common.cqrs.query.Query<CustomerValidationResult> {
        private String email;
        private String phoneNumber;
        private String correlationId;
    ...
    public static class CreateCustomerProfileCommand implements com.firefly.common.cqrs.command.Command<CustomerProfileResult> {
        private String customerId;
    ...
    public static class CreateAccountCommand implements com.firefly.common.cqrs.command.Command<AccountCreationResult> {
        private String customerId;
        private String accountType;
